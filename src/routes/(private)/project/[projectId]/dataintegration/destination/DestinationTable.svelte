...
<script lang="ts">
	...
	export let sources: ovhapi.cloud.project.dataIntegration.Destination[];
	const tableData: Writable<ovhapi.cloud.project.dataIntegration.Destination[]> = writable([]);

	$: {
		tableData.set(sources);
	}
